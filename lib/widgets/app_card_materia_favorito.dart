      ...
      return GridView.count(
        ...
        children: <Widget>[
          Container( 
            ...
            padding: const EdgeInsets.only(top: 2, right: 2), //Container da disciplina favoritas
            child: Container(
              child: Column(
                children: <Widget>[
                             Container(
                ...
                children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                maxLines: 2, //limita o texto em duas linhas
                                overflow: TextOverflow.ellipsis, //coloca os 3 pontinhos se caso ultrapassar a quantidade de caractes das 2 linhas
                                style: TextStyle(fontSize: 14),
                                ),
